...
// 사용자 파일의 실제 컬럼명을 우선 배치
const AMOUNT_KW      = ['처방액','처방금액','청구금액','약품금액','총금액','청구액','금액','amount'];
const FINAL_KW       = ['최종실적','지급금액','실적금액','최종금액'];
const SALESPERSON_KW = ['담당자','담당자명','담당자이름','담당자성명','영업담당자명','영업담당자','담당영업','사원명'];
const CSO_KW         = ['담당cso','cso명','cso'];
const HOSPITAL_KW    = ['처방처','처방처명','요양기관명','거래처명','기관명','병원명','의원명','약국명','거래처','기관명칭'];
