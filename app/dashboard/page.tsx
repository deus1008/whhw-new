    ...
    <>
      ...
      <div className="relative z-10 w-full px-4" style={{ maxWidth: '860px', paddingTop: '2rem', paddingBottom: '2rem', alignSelf: 'flex-start' }}>
        ...
        <div className="page-nav">
          ...
          <Link href="/customers"     style={navLink('#fbbf24', 'rgba(251,191,36,0.10)', 'rgba(251,191,36,0.28)')}>🏢 거래처현황</Link>          <Link href="/performance" style={navLink('#4ade80', 'rgba(74,222,128,0.10)', 'rgba(74,222,128,0.25)')}>📊 마감분석</Link>
