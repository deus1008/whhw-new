    ...
    <>
      ...
      <div className="relative z-10 w-full px-4" style={{ maxWidth: '860px', paddingTop: '2rem', paddingBottom: '2rem', alignSelf: 'flex-start' }}>
        ...
        <div className="page-nav">
          ...
          <Link href="/medical-search" style={navLink('#22d3ee', 'rgba(34,211,238,0.10)', 'rgba(34,211,238,0.28)')}>🏥 병원검색</Link>          <Link href="/performance" style={navLink('#4ade80', 'rgba(74,222,128,0.10)', 'rgba(74,222,128,0.25)')}>📊 마감분석</Link>
          <Link href="/mbo"         style={navLink('#f59e0b', 'rgba(245,158,11,0.10)', 'rgba(245,158,11,0.28)')}>🎯 MBO</Link>
